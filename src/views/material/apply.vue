<template>
  <div class="app-container">
    <div class="position">当前位置：<span>物资申请</span> </div>
    ...
    :src="url" >
        ...
        <el-table-column prop="shequname" label="社区名" width="100"></el-table-column>
        <el-table-column prop="tuanname" label="团长名" width="100"></el-table-column>
