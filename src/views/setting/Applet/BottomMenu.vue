    ...
    <el-card class="box-card">
      ...
      <el-form-item label="首页标题">
        ...
        <el-form-item label="选中图标">
          ...
          <p class="pstyle">此图为导航栏未选中状态图标，尺寸为81*81</p>
        </el-form-item>
