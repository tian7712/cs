  ...
  <div class="app-container">
    ...
    <el-card class="box-card">
      ...
      <el-button
       ...
       size="small"
        @click="add"
      >
       <svg-icon icon-class="jiahao" style="margin-right:1%" />添加公告</el-button>
    ...
    <el-table-column
      ...
      width="55">
        ...
        <el-table-column prop="Notice" label="	公告内容" width="800"></el-table-column>
...
export default {
  ...
  methods: {
    add() {
      this.$router.push({ path: "/setting/indexSetting/addNotice" });
    },
    edit() {
      this.$router.push({ path: "/setting/indexSetting/editNotice" });
    },
    del() {
