<template>
    ...
    <el-card class="box-card cardStyle">
      <el-form ref="form" :model="form" label-width="150px" label-position="left">
        ...
        <el-form-item label="图片">
          ...
          <p class="pstyle1">建议尺寸:120 * 120 , 请将所有图标尺寸保持1:1</p>
        </el-form-item>
  ...
  <el-radio v-model="radio" label="2">本小程序链接</el-radio>
   ...
   <el-radio v-model="radio" label="4">首页分类</el-radio>
    <el-radio v-model="radio" label="5">独立页分类</el-radio>
        </el-form-item>
         <el-form-item label="外链小程序appid">
      <el-input></el-input>
        </el-form-item>
